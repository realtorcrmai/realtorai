...
import { WORKFLOW_STAGE_MAP } from "@/lib/constants/workflows";
...
// NOTE: evaluateMilestoneCondition() and advanceLifecycleForContact() removed.
// Lifecycle workflows (buyer_lifecycle, seller_lifecycle) were redundant with StageBar.
// StageBar is now the single source of truth for pipeline position.
