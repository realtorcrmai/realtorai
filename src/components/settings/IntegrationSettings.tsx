            ...
            >
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  {integration?.is_active && (
                    <span className="flex items-center gap-1 text-xs font-medium text-[#0F7694] bg-[#0F7694]/5 px-2.5 py-1 rounded-full">
      ...
      {testResult && (
        <div
          className={`flex items-center gap-2 p-3 rounded-lg text-sm ${
            testResult.success
              ? "bg-[#0F7694]/5 text-[#0A6880] border border-[#0F7694]/20"
