      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="space-y-4 pt-2">
          ...
          {extractedFields.length > 0 && (
            <div className="space-y-2 p-3 bg-brand-muted border border-brand/20 rounded-lg">
              ...
              <div className="flex flex-wrap gap-1.5">
                {extractedFields.slice(0, 20).map((f) => (
                  <span
                    key={f}
                    className="px-2 py-0.5 bg-white text-xs rounded border border-brand/20"
                  >
                    {f}
                  </span>
                ))}
                {extractedFields.length > 20 && (
                  <span className="px-2 py-0.5 text-xs text-brand">
