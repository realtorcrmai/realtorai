      ...
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className={`text-xs px-4 py-2 rounded-lg font-medium transition-all ${
            saved ? "bg-brand text-white" : isPending ? "bg-gray-400 text-white" : "bg-primary text-white hover:bg-primary/90"
          }`}
        >
        ...
        <CardContent className="p-5 space-y-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`relative w-12 h-6 rounded-full transition-colors ${aiSending ? "bg-brand" : "bg-gray-300"}`}
            >
          ...
          <div className="flex items-center justify-between pt-4 border-t border-border">
            ...
            <button
              ...
              className={`relative w-12 h-6 rounded-full transition-colors ${weekendSending ? "bg-brand" : "bg-gray-300"}`}
            >
