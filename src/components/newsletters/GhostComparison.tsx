        ...
        {loading ? (
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-3 gap-2 text-center">
              <div className="bg-[#0F7694]/5 rounded-lg p-2.5 border border-[#0F7694]/20">
                <p className="text-lg font-bold text-[#0A6880]">
                  {comparisons.filter((c) => c.match).length}
                </p>
                <p className="text-[10px] text-[#0F7694]">AI Matched</p>
              </div>
            ...
            {comparisons.map((comp) => (
              <div key={comp.ghost.id} className="bg-muted/20 rounded-lg p-3 border space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  {comp.match ? (
                    <Badge className="bg-[#0F7694]/10 text-[#0A6880] text-[10px]">Match</Badge>
                  ) : comp.actual ? (
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  <div className="bg-[#0F7694]/5 rounded p-2">
                    <p className="text-[10px] text-[#0F7694] font-medium mb-0.5">AI Would Send:</p>
                    <p className="text-gray-700 truncate">{comp.ghost.subject}</p>
                  </div>
                  <div className="bg-[#0F7694]/5 rounded p-2">
                    <p className="text-[10px] text-[#0A6880] font-medium mb-0.5">Actually Sent:</p>
