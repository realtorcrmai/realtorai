...
export async function GET(
  ...
  try {
    ...
    console.error("[voice-agent] households/[id] GET error:", err);
...
export async function PATCH(
  ...
  try {
    ...
    console.error("[voice-agent] households/[id] PATCH error:", err);
    return NextResponse.json({ error: "Internal server error" }, { status: 500 });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    console.error("[voice-agent] households/[id] DELETE error:", err);
    return NextResponse.json({ error: "Internal server error" }, { status: 500 });
  }
}
