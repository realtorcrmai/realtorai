    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        <StatCard
          ...
          valueClassName={analytics.openRate > 40 ? "text-emerald-600" : "text-amber-500"}
        />
        <StatCard
          label="Click Rate"
          value={`${analytics.clickRate}%`}
          icon={<MousePointerClick className="h-5 w-5 text-muted-foreground" />}
          valueClassName={analytics.clickRate > 10 ? "text-emerald-600" : "text-amber-500"}
        />
      </div>
          ...
          <CardContent className="p-5">
            ...
            <div className="flex gap-8">
              <div>
                <div
                  className={`text-2xl font-bold ${
                    analytics.bounces === 0 ? "text-emerald-600" : "text-destructive"
                  }`}
                >
                  {analytics.bounces}
                </div>
              ...
              <div>
                <div
                  className={`text-2xl font-bold ${
                    analytics.unsubscribes === 0 ? "text-emerald-600" : "text-amber-500"
                  }`}
                >
                  ...
                  >
                    ...
                    <div
                      className={`text-center font-semibold ${
                        ctr > 10 ? "text-emerald-600" : "text-muted-foreground"
                      }`}
                    >
                      {ctr}%
                    </div>
