...
export default function ContactSyncPage() {
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto">
      ...
      {/* Result banner */}
      {result && (
        <div className="mb-4 p-4 bg-brand-muted border border-brand/20 rounded-xl">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-lg">🎉</span>
            <span className="font-semibold text-brand-dark">{result.message}</span>
          </div>
          <div className="flex gap-4 text-sm">
            <span className="text-brand-dark">✅ {result.imported} imported</span>
            <span className="text-yellow-700">⏭️ {result.skipped} skipped</span>
            <span className="text-brand-dark">🔄 {result.duplicates} duplicates</span>
