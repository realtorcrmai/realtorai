...
if (!SUPABASE_URL || !SUPABASE_KEY) {
  ...
  console.error("   Run with:  node --env-file=.env.local scripts/seed-email-marketing.mjs");
  console.error("   Or export them: source .env.local && node scripts/seed-email-marketing.mjs");
  process.exit(1);
}
